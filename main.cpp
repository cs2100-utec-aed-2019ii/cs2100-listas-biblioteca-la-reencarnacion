...
int main() {
    ...
    List<int>* doublecircularlist = new DoubleCircularList<int>();
    ...
    List<int>* doublecircularlist2 = new DoubleCircularList<int>(doublecircularlist1);
    doublecircularlist2->print();
    int dc_array[4] = {10,20,30,40};
    List<int>* doublecircularlist3 = new DoubleCircularList<int>(dc_array,4);
    doublecircularlist3->print();
    List<int>* doublecircularlist4 = new DoubleCircularList<int>(doublecircularlist->pop_back());
    doublecircularlist4->print();
    List<int>* doublecircularlist5 = new DoubleCircularList<int>(5);
